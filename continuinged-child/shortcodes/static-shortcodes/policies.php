            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="note-box">
                        ...
                        If you don't find what you need here, please <a href="/contact-us-help/">Contact Us</a> to phone or email us.
                    </div>

                    <!-- Privacy Policy -->
                    <div class="content-card">
                        <h2 class="section-title" id="privacy-policy">
                    ...
                    <!-- Refund Policy -->
                    <div class="content-card">
                        <h2 class="section-title" id="refund-policy">
                    ...
                    <!-- Complaint Procedure -->
                    <div class="content-card">
                        <h2 class="section-title" id="complaint-procedure">
                            <i class="bi bi-chat-square-text-fill"></i> Complaint Procedure
                        </h2>
                    ...
                    <!-- ADA Accommodations -->
                    <div class="content-card">
                        <h2 class="section-title" id="ada-accommodations">
                            <i class="bi bi-universal-access"></i> ADA Accommodations
                        </h2>
                    ...
                    <div class="content-card">
                        <h2 class="section-title" id="conflict-of-interest">
                            <i class="bi bi-exclamation-triangle-fill"></i> Conflict of Interest
                        </h2>
                        
                        <div class="conflict-notice">
                            We do not accept courses from authors for whom there are potential conflicts of interest, including commercial support, other authors, content of instruction, or any other relationship that could reasonably be construed as a conflict of interest.
                        </div>
                    </div>
                </div>               
            </div>
